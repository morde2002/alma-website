...
export const metadata: Metadata = {
  ...
  description: 'Join Mombasa\'s premier ladies martial arts academy. Women-only self-defense, karate, ladies fighting & Tong-Il Moo-Do classes with World Championship medalist Salma Ali Abdallah. Serving Mombasa, Kilifi, Kwale & Coast Region. Register today!',
